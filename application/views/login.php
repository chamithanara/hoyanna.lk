...
<head>
    ...
    <title>Hoyanna.lk - Login</title>

    <!-- Bootstrap Core CSS -->
    <link href="<?php echo base_url(); ?>/assets/css/bootstrap.min.css" rel="stylesheet">

    <!-- MetisMenu CSS -->
    <link href="<?php echo base_url(); ?>/assets/js/metisMenu/dist/metisMenu.min.css" rel="stylesheet">
...
<body style="background-color:#fcf8e3">
    ...
    <script src="<?php echo base_url(); ?>/assets/js/metisMenu/dist/metisMenu.min.js"></script>
